...
function _nonIterableRest() {
  ...
  methods: {
    ...
    isToday: function isToday(day) {
      var now = this.toolkit.getJalali(new Date());
      return now.yaer === this.thisMonth.current.yaer && now.month === this.thisMonth.current.monthSTD && now.date === day;
    }
  }
});var _withId = /*#__PURE__*/vue.withScopeId("data-v-0a5cef92");

vue.pushScopeId("data-v-0a5cef92");
...
script.__scopeId = "data-v-0a5cef92";// Import vue component
